...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'fmcfar200.github.io.data';
    var REMOTE_PACKAGE_BASE = 'fmcfar200.github.io.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 8678666;
      var PACKAGE_UUID = '0092b585-8a2f-455a-802d-64dda3d7cbaa';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 5886107, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(5886107, 5886600, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(5886600, 5890217, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(5890217, 7776069, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(7776069, 8651041, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(8651041, 8678666, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_fmcfar200.github.io.data');

    };
    Module['addRunDependency']('datafile_fmcfar200.github.io.data');
